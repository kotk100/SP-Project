...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    if(element) element.addEventListener('keyup', validateEmail);

    element = document.getElementById('Username');
    if(element) element.addEventListener('keyup', validateUsername);

    element = document.getElementById('password');
    if(element) element.addEventListener('keyup', validatePassword);
